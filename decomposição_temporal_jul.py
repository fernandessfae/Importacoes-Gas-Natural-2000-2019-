...
#Separação da importação de gás natural do mês de julho
data_jul = data.iloc[:, 9]

#Visualização do gráfico da série temporal de julho
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado em julho (mil m³)')
plt.plot(data_jul)

#Decomposição da série temporal do mês de julho
decomposicao = seasonal_decompose(data_jul)
