...
data_jul = data.iloc[:, 9:10]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_jul).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_jul, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
