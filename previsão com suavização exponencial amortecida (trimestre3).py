...
fit1 = Holt(t3).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(t3, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
