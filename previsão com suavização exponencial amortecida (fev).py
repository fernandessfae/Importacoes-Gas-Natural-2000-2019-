...
data_fev = data.iloc[:, 4:5]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_fev).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_fev, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
