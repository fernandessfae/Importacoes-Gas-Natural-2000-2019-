...
data_jan = data.iloc[:, 3:4]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_jan).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_jan, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
