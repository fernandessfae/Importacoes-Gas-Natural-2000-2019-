...
#Visualização do gráfico da série temporal do 3º trimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 3º trimestre (mil m³)')
plt.plot(t3)

#Decomposição da série temporal do 3º trimestre
decomposicao = seasonal_decompose(t3)
...
plt.figure(figsize = (10, 5))
plt.subplot(4, 1, 1)
plt.plot(t3, label = '3º Trimestre')
plt.legend(loc = 'best')
