...
data_ago = data.iloc[:, 10:11]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_ago).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_ago, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
