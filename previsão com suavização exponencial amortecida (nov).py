...
data_nov = data.iloc[:, 13:14]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_nov).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_nov, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
