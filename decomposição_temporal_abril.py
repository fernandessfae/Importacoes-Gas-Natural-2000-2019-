...
#Separação da importação de gás natural do mês de abril
data_abr = data.iloc[:, 6]

#Visualização do gráfico da série temporal de abril
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado em abril (mil m³)')
plt.plot(data_abr)

#Decomposição da série temporal do mês de abril
decomposicao = seasonal_decompose(data_abr)
