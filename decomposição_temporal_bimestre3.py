...
data['BIMESTRE2'] = data[['MAI', 'JUN']].sum(axis=1)

#Seleção da coluna bimestral
b3 = data.iloc[:, 16]

#Visualização do gráfico da série temporal do 3º bimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 3º bimestre (mil m³)')
plt.plot(b3)

#Decomposição da série temporal do 3º bimestre
decomposicao = seasonal_decompose(b3)
