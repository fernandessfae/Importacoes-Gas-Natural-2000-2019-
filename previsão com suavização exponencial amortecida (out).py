...
data_out = data.iloc[:, 12:13]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_out).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_out, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
