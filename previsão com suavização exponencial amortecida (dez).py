...
data_dez = data.iloc[:, 14:15]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_dez).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_dez, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
