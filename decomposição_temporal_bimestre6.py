...
#Visualização do gráfico da série temporal do 6º bimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 6º bimestre (mil m³)')
plt.plot(b6)

#Decomposição da série temporal do 6º bimestre
decomposicao = seasonal_decompose(b6)
