...
data_mar = data.iloc[:, 5:6]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_mar).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_mar, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
