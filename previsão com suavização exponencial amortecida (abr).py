...
data_abr = data.iloc[:, 6:7]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_abr).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_abr, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
