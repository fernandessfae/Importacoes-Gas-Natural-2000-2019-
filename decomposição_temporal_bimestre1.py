...
#Visualização do gráfico da série temporal do 1º bimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 1º bimestre (mil m³)')
plt.plot(b1)

#Decomposição da série temporal do 1º bimestre
decomposicao = seasonal_decompose(b1)
