...
fit1 = Holt(b4).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(b4, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
