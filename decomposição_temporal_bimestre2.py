...
#Visualização do gráfico da série temporal do 2º bimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 2º bimestre (mil m³)')
plt.plot(b2)

#Decomposição da série temporal do 2º bimestre
decomposicao = seasonal_decompose(b2)
