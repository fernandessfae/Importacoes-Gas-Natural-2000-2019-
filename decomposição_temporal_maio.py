...
#Separação da importação de gás natural do mês de maio
data_mai = data.iloc[:, 7]

#Visualização do gráfico da série temporal de maio
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado em maio (mil m³)')
plt.plot(data_mai)

#Decomposição da série temporal do mês de maio
decomposicao = seasonal_decompose(data_mai)
