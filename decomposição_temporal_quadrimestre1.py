...
#Visualização do gráfico da série temporal do 1º quadrimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 1º quadrimestre (mil m³)')
plt.plot(q1)

#Decomposição da série temporal do 1º quadrimestre
decomposicao = seasonal_decompose(q1)
...
plt.figure(figsize = (10, 5))
plt.subplot(4, 1, 1)
plt.plot(q1, label = '1º Quadrimestre')
plt.legend(loc = 'best')
