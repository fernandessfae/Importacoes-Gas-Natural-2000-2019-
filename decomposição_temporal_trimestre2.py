...
#Visualização do gráfico da série temporal do 2º trimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 2º trimestre (mil m³)')
plt.plot(t2)

#Decomposição da série temporal do 2º trimestre
decomposicao = seasonal_decompose(t2)
...
plt.figure(figsize = (10, 5))
plt.subplot(4, 1, 1)
plt.plot(t2, label = '2º Trimestre')
plt.legend(loc = 'best')
