...
data_mai = data.iloc[:, 7:8]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_mai).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_mai, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
