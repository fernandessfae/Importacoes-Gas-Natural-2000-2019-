...
#Visualização do gráfico da série temporal do 3º quadrimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 3º quadrimestre (mil m³)')
plt.plot(q3)

#Decomposição da série temporal do 3º quadrimestre
decomposicao = seasonal_decompose(q3)
...
plt.figure(figsize = (10, 5))
plt.subplot(4, 1, 1)
plt.plot(q3, label = '3º Quadrimestre')
plt.legend(loc = 'best')
