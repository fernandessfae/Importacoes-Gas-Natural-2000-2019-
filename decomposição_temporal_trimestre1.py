...
#Visualização do gráfico da série temporal do 1º trimestre
plt.figure(figsize = (10, 5))
plt.xlabel('Anos')
plt.ylabel('Quantidade de gás natural importado no 1º trimestre (mil m³)')
plt.plot(t1)

#Decomposição da série temporal do 1º trimestre
decomposicao = seasonal_decompose(t1)
...
plt.figure(figsize = (10, 5))
plt.subplot(4, 1, 1)
plt.plot(t1, label = '1º Trimestre')
plt.legend(loc = 'best')
