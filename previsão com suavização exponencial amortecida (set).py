...
data_set = data.iloc[:, 11:12]

#Treinamento do modelo Holt Winters simples
fit1 = Holt(data_set).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = False)
...
fit2 = Holt(data_set, damped = True).fit(smoothing_level = 0.8, smoothing_slope = 0.2, optimized = True)
